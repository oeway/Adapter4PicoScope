...
#include "BHL_Cl4000.h"
#include "ModuleInterface.h"

using namespace std;

const char* g_CameraName = "Cl4000";
...
///////////////////////////////////////////////////////////////////////////////
// BHL_Cl4000 implementation
// ~~~~~~~~~~~~~~~~~~~~~~~

/**
* BHL_Cl4000 constructor.
   ...
   thd_(0)
{
   ...
   int ret = CreateProperty(MM::g_Keyword_Description, "BHL_Cl4000 example adapter", MM::String, true);
...
*/
void BHL_Cl4000::GetName(char* name) const
{
...
int BHL_Cl4000::Initialize()
{
   ...
   // binning
   CPropertyAction *pAct = new CPropertyAction (this, &BHL_Cl4000::OnBinning);
   ...
   // pixel type
   pAct = new CPropertyAction (this, &BHL_Cl4000::OnPixelType);
...
*/
const unsigned char* BHL_Cl4000::GetImageBuffer()
{
...
* Required by the MM::Camera API.
*/
unsigned BHL_Cl4000::GetImageWidth() const
{
   return img_.Width();
}
...
* Required by the MM::Camera API.
*/
unsigned BHL_Cl4000::GetImageHeight() const
{
   return img_.Height();
}
...
* Required by the MM::Camera API.
*/
unsigned BHL_Cl4000::GetImageBytesPerPixel() const
{
   return img_.Depth();
} 
...
* Required by the MM::Camera API.
*/
unsigned BHL_Cl4000::GetBitDepth() const
{
...
* Required by the MM::Camera API.
*/
long BHL_Cl4000::GetImageBufferSize() const
{
...
* @param ySize - height
*/
int BHL_Cl4000::SetROI(unsigned x, unsigned y, unsigned xSize, unsigned ySize)
{
   if (xSize == 0 && ySize == 0)
   {
...
* Required by the MM::Camera API.
*/
int BHL_Cl4000::GetROI(unsigned& x, unsigned& y, unsigned& xSize, unsigned& ySize)
{
   x = roiX_;
   y = roiY_;
...
* Required by the MM::Camera API.
*/
double BHL_Cl4000::GetExposure() const
{
   return exposureMs_;
}
...
* Required by the MM::Camera API.
*/
void BHL_Cl4000::SetExposure(double exp)
{
   exposureMs_ = exp;
}
...
* Required by the MM::Camera API.
*/
int BHL_Cl4000::GetBinning() const
{
   return binning_;
}
...
* Required by the MM::Camera API.
*/
int BHL_Cl4000::SetBinning(int binF)
{
   return SetProperty(MM::g_Keyword_Binning, CDeviceUtils::ConvertToString(binF));
}

int BHL_Cl4000::PrepareSequenceAcqusition()
{
   if (IsCapturing())
 ...
 */
int BHL_Cl4000::StartSequenceAcquisition(double interval) {
...
*/                                                                        
int BHL_Cl4000::StopSequenceAcquisition()                                     
{                                                                         
   if (!thd_->IsStopped()) {
      thd_->Stop();                                                       
      thd_->wait();                                                       
...
*/
int BHL_Cl4000::StartSequenceAcquisition(long numImages, double interval_ms, bool stopOnOverflow)
{
   if (IsCapturing())
      return DEVICE_CAMERA_BUSY_ACQUIRING;
...
bool BHL_Cl4000::IsCapturing() {
   return !thd_->IsStopped();
}


///////////////////////////////////////////////////////////////////////////////
// BHL_Cl4000 Action handlers
///////////////////////////////////////////////////////////////////////////////

/**
* Handles "Binning" property.
*/
int BHL_Cl4000::OnBinning(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long binSize;
...
*/
int BHL_Cl4000::OnPixelType(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      string val;
...
*/
int BHL_Cl4000::OnGain(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      pProp->Get(gain_);
...
///////////////////////////////////////////////////////////////////////////////
// Private BHL_Cl4000 methods
///////////////////////////////////////////////////////////////////////////////

/**
* Sync internal image buffer size to the chosen property values.
*/
int BHL_Cl4000::ResizeImageBuffer()
{
